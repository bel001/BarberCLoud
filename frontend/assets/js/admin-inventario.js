const sessionInventarioAdmin = AUTH.requireSession();

let inventarioActual = [];

function mostrarIdentidad() {
  const nombre = sessionInventarioAdmin.name || sessionInventarioAdmin.email || "Administrador";
...
async function cargarInventario() {
  try {
    const data = await API.get("/admin/inventario", sessionInventarioAdmin.token);
